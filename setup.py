...
setuptools.setup(
    ...
    description='Vid2depth for tensorflow 2.x',
    author='Malte Koch',
    license='MIT',
    long_description=long_description,
    long_description_content_type="text/markdown",
    keywords=["tensorflow", "%s" % package_name, "bikevideodataset", 'bike', 'video', 'depth', 'prediction'],
    author_email='malte-koch@gmx.net',
    maintainer='Malte Koch',
    maintainer_email='malte-koch@gmx.net',
    url="https://github.com/baudcode/vid2depth",
    cmdclass={"clean": CleanCommand},
    packages=setuptools.find_packages(include=package_name + "/*"),
    install_requires=requirements,
    entry_points={
        'console_scripts': [
           "vid2depth-train=vid2depth.bin.train:main",
        ],
    },
    ext_modules=[],
    setup_requires=[],
